...
def render() -> None:
    ...
    share_query = serialize_state({"tab": "needing-attention", "tier": selected_tier})
    st.text_input("Copy link to this view", value=f"https://share.streamlit.io/?{share_query}", key="attention_share_link")
